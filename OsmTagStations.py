...
File comes from:http://overpass-api.de/api/interpreter?data=relation%283921495%29%3Brel%28r%29%3Brel%28r%29%3Bnode%28r%29%3Bout%3B
...
def _loadAllNodes():
    ...
    print("Loaded", len(aList), "stations from OSM")
    return aList
...
def isSoloStation(aId):
    return relatedStations(aId) is None
